...
import { acceptTask, cancelBooking, completeTask, createBooking, getAllBookings, getAllTasks, getBookingDetails, getTasksDetails, rejectTask, rescheduleBooking, startTask } from "../controllers/booking.controller.js";
...
router.get('/provider/bookings/:id', protectRoute, requireRole('provider'), getTasksDetails);
